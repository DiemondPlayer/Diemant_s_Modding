...
import net.diemond_player.diemants_test.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.SAPPHIRE, new StatusEffectInstance(StatusEffects.HASTE, 400, 2)).build();
    ...
    private boolean hasFullSuitOfArmorOn(PlayerEntity player) {
        ...
        return !boots.isEmpty() && !chestplate.isEmpty()
                && !leggings.isEmpty() && !helmet.isEmpty();
    }
}
