...
import net.diemond_player.diemants_test.block.entity.GemEmpoweringStationBlockEntity;
...
public class GemEmpoweringStationScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final GemEmpoweringStationBlockEntity blockEntity;
    public GemEmpoweringStationScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public GemEmpoweringStationScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity,
