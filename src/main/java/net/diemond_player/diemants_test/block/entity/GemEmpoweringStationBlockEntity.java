...
public class GemEmpoweringStationBlockEntity extends BlockEntity
    ...
    private final static int FLUID_ITEM_SLOT = 1;
    private final static int OUTPUT_SLOT = 2;
    private final static int ENERGY_ITEM_SLOT = 3;
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new GemEmpoweringStationScreenHandler(syncId, playerInventory, this, propertyDelegate);
    }
